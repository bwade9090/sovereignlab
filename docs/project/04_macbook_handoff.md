...
- Work unit B and its owner-review boundary are complete.
  ...
  current 10/40 approved-core count.
...
7. `docs/project/07_core_authoring_matrix.md` — the approved 40-record allocation, first four
   approved batches (10/40), and human-review boundary.
...
- The approved core count is exactly 10/40. The four records in
