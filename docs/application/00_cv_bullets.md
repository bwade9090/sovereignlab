...
- Last updated: 2026-08-26 (M2 mid-window refresh: 14/40 approved core, ADR 0008 slices 1–9 and
  work unit C complete, 75-file/1,153-test baseline)
...
- Building **K-VINTAGE**, a bilingual Korean/English benchmark whose gold answers depend on the
  ...
  CLI, a neighboring measure outside the sole owner-approved OECD raw-data scope — with
  machine-generated revision probes to be reported separately.
...
- Building **SovereignLab / K-VINTAGE** (in progress): to our knowledge, for official statistics,
  ...
  1,153 tests pass at 100% statement/branch coverage; temporal leakage is the planned headline
...
the 26 unauthored core slots, and the not-yet-evaluated model variants.
...
- Do not cite benchmark size until each counted test item passes schema and human review; **always report the human-reviewed core and machine-generated probes as separate counts**. The current approved core count is 14/40; the 26 remaining slots are neither authored nor approved.
