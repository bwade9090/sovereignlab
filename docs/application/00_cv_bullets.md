...
- Last updated: 2026-08-25 (M2 mid-window refresh: 12/40 approved core, ADR 0008 slices 1–9 and
  work unit C complete, 74-file/1,147-test baseline)
...
- Building **K-VINTAGE**, a bilingual Korean/English benchmark whose gold answers depend on the
  ...
  CPI snapshot — with machine-generated revision probes to be reported separately.
...
- Building **SovereignLab / K-VINTAGE** (in progress): to our knowledge, for official statistics,
  ...
  1,147 tests pass at 100% statement/branch coverage; temporal leakage is the planned headline
...
the 28 unauthored core slots, and the not-yet-evaluated model variants.
...
- Do not cite benchmark size until each counted test item passes schema and human review; **always report the human-reviewed core and machine-generated probes as separate counts**. The current approved core count is 12/40; the 28 remaining slots are neither authored nor approved.
