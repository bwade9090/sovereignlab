"""Contract and evidence checks for the draft kv-core-data-04 pair."""
...
def test_approved_core_remains_ten_and_drafts_are_separate() -> None:
    matrix = CoreAuthoringMatrix.model_validate_json(MATRIX_PATH.read_text(encoding="utf-8"))
    approved = tuple(
    ...
    assert matrix.target_record_count - len(approved) - len(drafts) == 28
