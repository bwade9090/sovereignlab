"""Contract and evidence checks for the approved kv-core-abstain-02 pair."""
...
BATCH_PATH = CORE_DIRECTORY / "core-batch-006.jsonl"
...
def test_approved_core_contains_fourteen_records_and_the_new_pair() -> None:
    approved = tuple(
